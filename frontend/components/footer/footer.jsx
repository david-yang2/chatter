        ...
        return(
            <div className="footer" >
                ...
                <div className="project">
                    ...
                    <a href="https://explorationawaits.herokuapp.com/" target="_blank" rel="noopener noreferrer"><img width="100%" src={"/explorationawaits.png"} alt="" /></a>
                </div>
                ...
                <div className="project">
                    ...
                    <a href="https://explorationawaits.herokuapp.com/" target="_blank" rel="noopener noreferrer"><img width="100%" src={"/whatsfordinner.png"} alt="" /></a>
